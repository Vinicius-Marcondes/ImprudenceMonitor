                    ...
                    <div class="container">
						...
						<div class="panel panel-border panel-primary">
                            ...
                            <div class="panel-body"> 
								<?php if(isset($_SESSION['msg_edit_equipamentos'])){ echo $_SESSION['msg_edit_equipamentos']; unset($_SESSION['msg_edit_equipamentos']); } if($equipamento['PESSOAS_ID_PESSOAS'] == $_SESSION['id']){ ?>
                                <form role="form" method="post" action="processos/editar_equipamentopessoal.php">
									...
									<div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $equipamento['SERIAL_EQUIPAMENTOS']; ?>" id="serial" name="serial" class="form-control" pattern=".{25,25}" title="Necessário 25 digitos" required>
                                    </div>
									<div class="row">
									<div class="col-lg-11 col-md-9 col-sm-9 col-xs-5"><a href="equipamentospessoais.php">Voltar</a></div>
