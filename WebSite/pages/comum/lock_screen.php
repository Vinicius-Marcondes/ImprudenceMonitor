...
<?php 
	...
	if(isset($_POST['senha'])){
		...
		$selecao_pessoa = "SELECT * FROM pessoas WHERE ID_PESSOAS = '$cod' AND SENHA_PESSOAS = '$senha'";
                ...
                <div class="panel-body" style="padding-top:0px;">
                 <form method="post" action="lock_screen.php" role="form" class="text-center"> 
                    <div class="user-thumb"> 
                        <img src="../../images/0_pessoas/<?php echo $_SESSION['logo']; ?>" class="img-responsive img-circle img-thumbnail" alt="thumbnail">
                    </div> 
