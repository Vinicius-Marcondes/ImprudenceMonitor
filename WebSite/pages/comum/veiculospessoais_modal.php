<div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog"> 
        <div class="modal-content"> 
			...
			<form method="post" action="processos/adicionar_veiculopessoal.php">
            <div class="modal-body">
				<?php 
					$selecao_equipamento = "SELECT * FROM equipamentos_pessoais WHERE PESSOAS_ID_PESSOAS = $_SESSION[id]"; 
					...
					while($equipamento = mysqli_fetch_assoc($consulta_equipamento)){ 
						...
						$selecao_veiculo = "SELECT * FROM automoveis_pessoais WHERE EQUIPAMENTOS_PESSOAIS_ID_EQUIPAMENTOS = $id";
