<div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog"> 
        <div class="modal-content"> 
			...
			<form method="post" action="processos/adicionar_equipamentopessoal.php">
                ...
                <div class="row"> 
					<div class="col-md-12"> 
                        <div class="form-group"> 
                            ...
                            <input type="text" class="form-control" id="field-3" placeholder="Ex: 9999999999999999999999999" pattern=".{25,25}" title="Necessário 25 digitos" name="serial" required> 
                        </div> 
                    </div> 
                </div> 
            </div> 
