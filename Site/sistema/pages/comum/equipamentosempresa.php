...
<html>
    ...
    <body class="fixed-left">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
												<?php 
													$selecao_equipamentos = "SELECT * FROM equipamentos_empresa WHERE EMPRESA_ID_EQUIPAMENTOS = $_SESSION[empresa]";
                                                ...
                                                <table id="datatable" class="table table-small-font table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="actions">
																<a href="visualizar_equipamentosempresa.php?id=<?php echo $equipamento['ID_EQUIPAMENTOS']; ?>"><i class="fa fa-binoculars"></i></a>
																<a href="editar_equipamentosempresa.php?id=<?php echo $equipamento['ID_EQUIPAMENTOS']; ?>"><i class="fa fa-pencil"></i></a>
																<a href="processos/deletar_equipamentoempresa.php?id=<?php echo $equipamento['ID_EQUIPAMENTOS']; ?>"><i class="fa fa-trash-o"></i></a>
															</td>
                                                        </tr>
														<?php } ?>
                                                    </tbody>
		...
		<?php include_once('equipamentosempresa_modal.php'); include_once('includes/scripts_ok.php'); ?>
	</body>
</html>