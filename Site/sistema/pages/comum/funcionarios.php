...
<html>
    ...
    <body class="fixed-left">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
												<?php 
													$selecao_funcionarios = "SELECT * FROM pessoas INNER JOIN perfil ON pessoas.PERFIL_ID_PESSOAS = perfil.ID_PERFIL WHERE EMPRESA_ID_PESSOAS = $_SESSION[empresa]";
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="actions">
																...
																<?php if($funcionario['ID_PESSOAS'] != $_SESSION['id']){ ?>
		...
		<?php include_once('funcionarios_modal.php'); include_once('funcionarios_modal2.php'); include_once('includes/scripts_ok.php'); 
