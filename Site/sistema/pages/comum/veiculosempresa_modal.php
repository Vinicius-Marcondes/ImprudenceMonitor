    ...
    <div class="modal-dialog"> 
        <div class="modal-content"> 
            ...
            <div class="modal-body">
				<?php 
					$selecao_equipamento = "SELECT * FROM equipamentos_empresa WHERE EMPRESA_ID_EQUIPAMENTOS = $_SESSION[empresa]"; 
                    ...
                    <div class="col-md-6"> 
                        <div class="form-group">  
                            <select class="select2" name="id" required>
                                <?php 
                                    $selecao_pessoa = "SELECT * FROM pessoas WHERE EMPRESA_ID_PESSOAS = $_SESSION[empresa]"; 
