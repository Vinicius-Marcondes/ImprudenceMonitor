					...
					<div class="wraper container-fluid">
						...
						<div class="row">
							<?php 
								...
								$imprudencias = 0;
								$selecao_imprudencia = "SELECT * FROM imprudencias WHERE PESSOAS_ID_IMPRUDENCIAS = $_SESSION[id]";
								$consulta_imprudencia = $conexao_bd->query($selecao_imprudencia);
								while ($imprudencia = mysqli_fetch_array($consulta_imprudencia)) {
									$imprudencias = $imprudencias + 1;
								}
											...
											<div class="col-md-12">
												<div class="panel panel-border panel-primary">
													...
													<div class="panel-body"> 
														...
														<div class="about-info-p m-b-0"><strong>Quantidade de Imprudências</strong><br/><p class="text-muted"><?php echo $imprudencias; ?></p></div>
									...
									<div class="tab-pane <?php if($page == "3"){ echo "active"; } ?>" id="messages-2">
										<div class="panel panel-border panel-primary">
											...
											<div class="panel-body"> 
												...
												<?php
														if($_SESSION['funcao'] == "RH"){
															echo "<a href='veiculosempresa.php'>Veículos</a> | <a href='equipamentosempresa.php'>Equipamentos</a> | <a href='funcionarios.php'>Funcionários</a> | <a href='consultar.php'>Consultar meus dados</a>";
														} else {
															echo "<a href='consultar.php'>Consultar meus dados</a>";
														}
												 	} else { echo "Você não está interligado com nenhuma empresa, passe o código <font style='color: blue;'><b>$_SESSION[id]</b></font> para sua empresa interligar você à ela."; } ?>
											</div> 
										</div>
									</div> 
