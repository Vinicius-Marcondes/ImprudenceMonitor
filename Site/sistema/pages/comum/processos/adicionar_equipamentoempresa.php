<?php 
	...
	if($_POST){
		...
		// Inserção dos Dados
		if(isset($serial)){
			$set_equipamento = "UPDATE equipamentos_empresa SET NOME_EQUIPAMENTOS = '$nome', MODELO_EQUIPAMENTOS = '$modelo', EMPRESA_ID_EQUIPAMENTOS = '$_SESSION[empresa]' WHERE SERIAL_EQUIPAMENTOS = '$serial'";
