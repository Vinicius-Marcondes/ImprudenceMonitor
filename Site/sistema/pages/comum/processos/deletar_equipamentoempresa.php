<?php 
	...
	$selecao_veiculo = "UPDATE automoveis_empresa SET EQUIPAMENTOS_ID_AUTOMOVEIS = NULL WHERE EQUIPAMENTOS_ID_AUTOMOVEIS = '$id' AND EMPRESA_ID_AUTOMOVEIS = $_SESSION[empresa]";
	$update_veiculo = $conexao_bd->query($selecao_veiculo);
	
	$set_equipamento = "UPDATE equipamentos_empresa SET EMPRESA_ID_EQUIPAMENTOS = NULL WHERE EMPRESA_ID_EQUIPAMENTOS = '$_SESSION[empresa]'";
