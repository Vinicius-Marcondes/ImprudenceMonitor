                    ...
                    <div class="container">
						...
						<div class="panel panel-border panel-primary">
                            ...
                            <div class="panel-body"> 
								<?php if(isset($_SESSION['msg_edit_funcionarios'])){ echo $_SESSION['msg_edit_funcionarios']; unset($_SESSION['msg_edit_funcionarios']); } if($pessoa['EMPRESA_ID_PESSOAS'] == $_SESSION['id']){ ?>
