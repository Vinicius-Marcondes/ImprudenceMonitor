                ...
                <div class="content">
                    <div class="container">
						...
						<div class="panel panel-border panel-primary">
							<?php 
								$id = $_GET['id'];
								$selecao_veiculo = "SELECT * FROM automoveis_empresa WHERE ID_AUTOMOVEIS = $id AND EMPRESA_ID_AUTOMOVEIS = $_SESSION[id]";
                            ...
                            <div class="panel-body"> 
								<?php if($veiculo['EMPRESA_ID_AUTOMOVEIS'] == $_SESSION['id']){?>
